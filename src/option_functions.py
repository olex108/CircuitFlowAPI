"""
В модуле функции основных операций пользователя
"""
...
def open_project(project_name_data: dict):
    """
    Функция принимает словарь с именными данными проекта, выводит их с помощью функции print_dictionary_lines

    Проверяет внесены ли по этому названию данные, для чего обращается к базе данных и проводит проверку:
        - Если данные внесены предлагает действия:
            - Посмотреть данные - вызов функции print_dictionary_lines
            - Изменить данные - вызов функции change_project_parameters
            - Расчитать стоимость работ - вызов функции calculate_estimate.calculate_estimate
        Все варианты вызывают функцию open_project для рекурсии блока

        - Если данных нет предлагает их внести с помощью функции create_project_parameters
